export default {
  ...
  stats: {
    potential_reach: 'Потенційна аудиторія',
    activity_percentage: 'активності',
    popularity_percentage: 'цитованості',
    adoption_percentage: 'зареєстрованих',
    top_regions: 'Найпопулярніший регіон',
  },
  statsDescriptions: {
    potential_reach: 'Кількість людей, що може бачити ваші оголошення завдяки спільним друзям та знайомим',
    activity_percentage:
      'Стільки відсотків користувачів є більш активними, ніж ви. Активність вимірюється різними діями у Рекаріо — розміщення своїх оголошень, перегляд оголошень інших людей тощо',
    popularity_percentage:
      'Стільки відсотків користувачів є більш цитованими за вас. Цитованість — це сума різних метрик: перегляд ваших оголошень, їх обговорення з друзями тощо ',
    adoption_percentage: 'Стільки відсотків користувачів зарєєструвалися раніше вас',
    top_regions: 'Більшість оголошень, що ви можете бачити через друзів та знайомих знаходяться у цьому регіоні',
  },
  feed: {
    permissionBoxText:
    ...
    permissionBoxHeader: 'Доступ до контактної книги відсутній',

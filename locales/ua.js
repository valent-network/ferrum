export default {
  listNotFound: "Жодного оголошення не знайдено",
  nav: {
    titles: {
      feed: "Стрічка",
      chats: "Чати",
  ...
  feed: {
    permissionBoxText: "Нам потрібен дозвіл на доступ до вашої контактної книг, щоб показувати, хто з вашіх друзів та знайомих наразів продає автомобіль",
  ...
  ad: {
    shareText: "Привіт! Ти можешь знати продавця:",
  ...
  chat: {
    ...
    you: "Ви",
    introHeader: "Ім'я вашого друга для інишх:",
  ...
  profile: {
    ...
    inviteFriendSMSText: "Вітаю! Дивись, що знайшлося — тут дуже зручно продати чи купити авто через друзів та знайомих — https://recar.io/get",
    deleteContactsNote: "Увага! Не забудьте заборонити доступ до контактної книги в налаштуваннях телефона, щоб уникнути синхронізації наступного разу як повернетесь до Рекаріо",
    inviteFriendsNote: "Чим більше друзів у Рекаріо, тим краще для вас. Навіть, якщо ніхто з ваших друзів наразі не зацікавлений в купівлі чи продажі авто, вони можут знати тих, кому це потрібно",
    nameNotPresent: "Без імені",
    contactsSuccessfullyDeleted: "Контактна книга була успішно видалена",
    actions: {
      changeAvatarTitle: "Змінити фото",
      deleteContactsTitle: "Ви впевнені, що хочете видалити вашу контактну книгу з серверів Рекаріо? Щоб завантажити їх знову, вийдіть з додатку та зайдіть знову",
    ...
    referrer: {
      ...
      friendInvitesYou: "запрощує вас до Рекаріо",
      buttons: {
  ...
  login: {
    ...
    headers: {
      ...
      secondary: "Ми відпраимо вам код у SMS, щоб ви не вигадували черговий пароль",
      smsWasSent: "SMS з кодом будло відправлено на номер",
  ...
  wizzard: {
    ...
    helloH1: "Тримай руку на пульсы з Рекаріо",

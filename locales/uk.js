export default {
  ...
  feed: {
    permissionBoxText: "Нам потрібен дозвіл на доступ до вашої контактної книг, щоб показувати, хто з вашіх друзів та знайомих наразі продає автомобіль",
  ...
  ad: {
    ...
    alerts: {
      ...
      confirm_archive: "Ви впевнені, що хочете сховати це оголошення? Його не можна будет знайти через пошук, але воно залишиться у чатах, улюблених та відвіданих",
    },
    params: {
      title: "Назва",
      description: "Опис",
  ...
  profile: {
    ...
    inviteFriendsNote: "Чим більше друзів у Рекаріо, тим краще для вас. Навіть, якщо ніхто з ваших друзів наразі не зацікавлений у купівлі чи продажі авто, вони можуть знати тих, кому це потрібно",
